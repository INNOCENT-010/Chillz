...
const HOTEL_FEATURES = [
  ...
  "Room Service", "Conference Room", "Airport Shuttle", "Beach Access",
  "Breakfast Included", "AC", "Generator", "Security", "CCTV",
  "Laundry", "Business Center", "Kids Play Area", "Pet Friendly",
];
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#F7F5FA", maxWidth: 480, margin: "0 auto", paddingBottom: 40 }}>
      ...
      <div style={{ backgroundColor: "#FFFFFF", padding: "16px", display: "flex", alignItems: "center", gap: 10, borderBottom: "1px solid #F2EEF9", position: "sticky", top: 0, zIndex: 40 }}>
        ...
        <div style={{ flex: 1 }}>
          <h1 style={{ fontSize: 18, fontWeight: 900, color: "#0A0A0A", margin: 0, fontFamily: "var(--font-display,Syne,sans-serif)" }}>My Hotel</h1>
          <p style={{ fontSize: 11, color: "#9E9E9E", margin: 0 }}>Edit your hotel profile</p>
        </div>
      ...
      <div style={{ padding: "20px 16px", display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <>
            <div>
              ...
              <input type="text" value={form.business_name}
                ...
                placeholder="e.g. De Renaissance Hotel" style={inputStyle} />
            </div>
            <div>
              <label style={labelStyle}>Description</label>
              <textarea value={form.description}
                onChange={e => setForm(p => ({ ...p, description: e.target.value }))}
                placeholder="Tell guests about your hotel, what makes it special, nearby attractions..."
        ...
        {activeTab === "Contact" && (
          <>
            <div style={{ backgroundColor: "#FFFBEB", border: "1px solid #FDE68A", borderRadius: 14, padding: "12px 14px" }}>
              <p style={{ fontSize: 12, fontWeight: 700, color: "#92400E", margin: "0 0 3px" }}>Why this matters</p>
              <p style={{ fontSize: 11, color: "#B45309", margin: 0, lineHeight: 1.5 }}>
                Guests discover your hotel and want to reach you directly. Every field you fill in appears as a contact button on your hotel page.
              </p>
            </div>
            ...
            <div>
              ...
              <p style={{ fontSize: 11, color: "#9E9E9E", margin: "4px 0 0" }}>Include country code e.g. +2348012345678</p>
            </div>
            ...
            <div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10, backgroundColor: "#F7F5FA", border: "1.5px solid #E4DCF0", borderRadius: 14, padding: "12px 14px" }}>
                ...
                <input type="email" placeholder="hotel@example.com" value={form.contact_email}
            ...
            <div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10, backgroundColor: "#F7F5FA", border: "1.5px solid #E4DCF0", borderRadius: 14, padding: "12px 14px" }}>
                ...
                <input type="text" placeholder="yourhotel" value={form.instagram.replace(/^@/, "")}
            ...
            <div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10, backgroundColor: "#F7F5FA", border: "1.5px solid #E4DCF0", borderRadius: 14, padding: "12px 14px" }}>
                <span style={{ fontSize: 18, flexShrink: 0 }}>🌐</span>
                <input type="url" placeholder="https://yourhotel.com" value={form.website}
            ...
            {(form.whatsapp || form.phone || form.contact_email || form.instagram || form.website) && (
              <div style={{ backgroundColor: "#F7F5FA", borderRadius: 16, padding: "14px" }}>
                ...
                <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                  ...
                  {form.phone       && <div style={{ display: "flex", alignItems: "center", gap: 6, backgroundColor: ACCENT_BG, border: "1px solid #FDE68A", borderRadius: 10, padding: "7px 12px" }}><span>📞</span><span style={{ fontSize: 12, fontWeight: 700, color: ACCENT }}>Call</span></div>}
        ...
        {activeTab === "Features" && (
          <>
            <div style={{ backgroundColor: "#FFFBEB", border: "1px solid #FDE68A", borderRadius: 14, padding: "12px 14px" }}>
              <p style={{ fontSize: 12, fontWeight: 700, color: "#92400E", margin: "0 0 3px" }}>Hotel Facilities</p>
              <p style={{ fontSize: 11, color: "#B45309", margin: 0, lineHeight: 1.5 }}>
            ...
            {form.filters.length > 0 && (
              <p style={{ fontSize: 12, color: "#9E9E9E", textAlign: "center", margin: 0 }}>
                {form.filters.length} facilit{form.filters.length === 1 ? "y" : "ies"} selected
              </p>
            )}
          </>
        )}
        ...
        {activeTab === "Videos" && (
          <>
            <div style={{ backgroundColor: "#FFFBEB", border: "1px solid #FDE68A", borderRadius: 14, padding: "12px 14px" }}>
              <p style={{ fontSize: 12, fontWeight: 700, color: "#92400E", margin: "0 0 3px" }}>Watch Before You Book</p>
              <p style={{ fontSize: 11, color: "#B45309", margin: 0, lineHeight: 1.5 }}>
                Add YouTube, Instagram or TikTok links showcasing your hotel and rooms. These appear in the "Watch Before You Book" section on your detail page.
              </p>
            </div>
            <VideoLinksInput
              value={form.videos}
        ...
        <button onClick={() => saveMutation.mutate()} disabled={saveMutation.isPending}
          style={{ width: "100%", padding: "15px 0", borderRadius: 16, border: "none", backgroundColor: saveMutation.isPending ? "#9E9E9E" : ACCENT, color: "#FFFFFF", fontSize: 15, fontWeight: 700, cursor: saveMutation.isPending ? "not-allowed" : "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, boxShadow: `0 4px 16px rgba(217,119,6,0.3)` }}>
          {saved
