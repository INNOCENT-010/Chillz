...
import { Mail, ArrowRight, Eye, EyeOff, Lock, X, Building2 } from "lucide-react";
...
export default function LoginPage() {
  ...
  const handleSignIn = async () => {
    ...
    try {
      ...
      // Check redirect param first — bounced from protected route
      ...
      // Check admin by email or metadata
      const isAdmin =
        data.user.user_metadata?.role === "admin" ||
        data.user.email?.endsWith("@chillz.admin"); // update to match your admin email pattern
  ...
  return (
    <div style={{
      ...
      {/* Purple hero */}
      <div style={{
        background: "linear-gradient(160deg, #3D0066 0%, #5B0EA6 55%, #7B2FBE 100%)",
        ...
        <motion.div
          ...
          <span style={{ fontSize: 22, fontWeight: 900, color: "#5B0EA6", fontFamily: "var(--font-display, Syne, sans-serif)" }}>CZ</span>
        </motion.div>
      ...
      <div style={{ flex: 1, padding: "28px 20px 40px", display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <div>
          <h2 style={{ fontSize: 22, fontWeight: 900, color: "#0A0A0A", margin: "0 0 4px", fontFamily: "var(--font-display, Syne, sans-serif)" }}>
            Welcome back
          </h2>
          <p style={{ fontSize: 13, color: "#9E9E9E", margin: 0 }}>
            Sign in to your Chillz account
          </p>
        </div>
              ...
              {showEmailSuggestions && filteredSuggestions.length > 0 && (
                <motion.div
                  ...
                  style={{
                    ...
                    backgroundColor: "#FFFFFF", border: "1.5px solid #E4DCF0",
                    borderRadius: 14, overflow: "hidden", zIndex: 50,
                    boxShadow: "0 8px 24px rgba(91,14,166,0.12)",
                  }}>
                  <p style={{ fontSize: 10, fontWeight: 700, color: "#9E9E9E", textTransform: "uppercase", letterSpacing: "0.06em", padding: "8px 14px 4px", margin: 0 }}>
                    Recent
                  </p>
                  {filteredSuggestions.map((email, i) => (
                    <button
                      key={email}
                      onMouseDown={() => { setForm({ ...form, email }); setShowEmailSuggestions(false); }}
                      style={{
                      ...
                      <span style={{ fontSize: 13, color: "#0A0A0A", fontWeight: 500, flex: 1, overflow: "hidden", whiteSpace: "nowrap", textOverflow: "ellipsis" }}>
                        {email}
                      </span>
                    </button>
                  ))}
          ...
          <div style={fieldStyle}>
            ...
            <button
              ...
              {showPassword
                ...
                : <Eye size={16} style={{ color: "#9E9E9E" }} />}
            </button>
          </div>
        </div>
        ...
        <button
          ...
          style={{
            ...
            boxShadow: loading ? "none" : "0 4px 16px rgba(91,14,166,0.3)",
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10, marginTop: 4 }}>
          <p style={{ textAlign: "center", fontSize: 14, color: "#6B6B6B", margin: 0 }}>
            ...
            <Link href="/register" style={{ color: "#5B0EA6", fontWeight: 700, textDecoration: "none" }}>
              Create one
            </Link>
          </p>
